...
#model_name_prefixes = ['model_tabla_bce_ourmix_finetune_' , 'model_tabla_bce_western_finetune_' ] 
#model_names = ['model_tabla_mtl_finetune_bce_0_1', 'model_tabla_mtl_finetune_bce_1_1' , 'model_tabla_mtl_finetune_bce_2_1' , 'model_tabla_mtl_finetune_nl_bce_0_3']

model_names = ['model_tabla_mtl_finetune_nl2_bce_0_3']

for model_name in model_names:
  #model_name = model_name_prefix + str(x) + '_' + str(y)
  model = '../new_mtl_sf_models/' + model_name + '/'
  ...
  for track in mus.tracks:
      ...
      print(track.name)
      estimates = test_mtl_sf.separate(
          audio=track.audio,
          targets=targets,
          model_name=model,
          niter=2,
